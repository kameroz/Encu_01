...
$datos = "SELECT noticia.titulo FROM noticia,notfoto where  noticia.idnot = '$foto' limit 1";
if($resultado = $conn->query($datos)){
    while($fila = $resultado->fetch_row()){?>
     <tr>
          <td align="center">
...
$datos = "SELECT noticia.texto FROM noticia,notfoto where  noticia.idnot = '$foto' limit 1";
if($resultado = $conn->query($datos)){
    while($fila = $resultado->fetch_row()){?>
        <tr>
