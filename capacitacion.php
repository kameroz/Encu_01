...
$datos = "SELECT curso.titulo,curso.duracion,curso.desc,programado.FI,programado.FT FROM curso,programado where curso.activo = 1 and curso.idcurso = programado.idcurso";
if($resultado = $conn->query($datos)){
    while($fila = $resultado->fetch_row()){?>
      <td><font color="black"><?php echo $fila[0];?></font></td>
       <td><font color="black"><?php echo $fila[2];?></font></td>
       <td><font color="black"><?php echo $fila[1];?></font></td>
       <td><font color="black"><?php echo $fila[3];?></font></td>
       <td><font color="black"><?php echo $fila[4];?></font></td>
        </tr>
        <?php
    }
}
