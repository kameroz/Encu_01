...
$datos = "SELECT noticia.titulo FROM noticia,notfoto where  noticia.idnot = '$foto' limit 1,1";
if($resultado = $conn->query($datos)){
    while($fila = $resultado->fetch_row()){?>
     <tr>
          <td align="center">
      <font color="black"><b><h3><?php echo $fila[0];?></h3></b></font>
          </td>
      </tr>
        <?php
    }
}
$datos = "SELECT noticia.texto FROM noticia,notfoto where  noticia.idnot = '$foto' limit 1,1";
if($resultado = $conn->query($datos)){
    while($fila = $resultado->fetch_row()){?>
        <tr>
          <td WIDTH="50px" HEIGHT="50px">
      <div HEIGHT="50"><font color="black" ><b><h3><?php echo $fila[0];?></h3></b></font></div>
          </td>
      </tr>    
        <?php
    }
